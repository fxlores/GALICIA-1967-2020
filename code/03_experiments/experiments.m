...
% Table of phi-statistics of components 
Tphi=['fid2=fopen("figures/tablephiTNO.tex","w");'];
eval(Tphi)
ex=['sgy=(1./sum((ycm_t(:,1:6)).^2))./sum(1./sum((ycm_t(:,1:6)).^2));'];
eval(ex)
ex=['sgh=(1./sum((hcm_t(:,1:6)).^2))./sum(1./sum((hcm_t(:,1:6)).^2));'];
eval(ex)
ex=['sgx=(1./sum((xcm_t(:,1:6)).^2))./sum(1./sum((xcm_t(:,1:6)).^2));'];   
eval(ex)
ex=['sgl=(1./sum((ccm_t(:,1:6)).^2))./sum(1./sum((ccm_t(:,1:6)).^2));'];   
eval(ex)
sg=[sgh;sgy;sgx;sgl];
fprintf(fid2,'\n  $l$    & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f		\\\\',[sg(1,1:3) sg(1,6) sg(1,4:5)]');
fprintf(fid2,'\n  $y$    & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f	    \\\\',[sg(2,1:3) sg(2,6) sg(2,4:5)]');
fprintf(fid2,'\n  $x$    & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f		\\\\',[sg(3,1:3) sg(3,6) sg(3,4:5)]');
fprintf(fid2,'\n  $s_l$    & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f		',[sg(4,1:3) sg(4,6) sg(4,4:5)]');
fclose(fid2);
...
% Table of sigma-statistics of components 
   fid2=fopen("tables/tablesigma.tex","w");
   fprintf(fid2,'\\begin{table}[h]');
   fprintf(fid2,'\\caption{\\textsc{$\\sigma$-statistics.}} \\label{sigma-statistics}');
   fprintf(fid2,'\n \\begin{center}');
   fprintf(fid2,'\n \\begin{tabular}{lcccccc}');
   fprintf(fid2,'\n \\hline\\hline');
   fprintf(fid2,'\n \\textbf{Variable} &${\\sigma}_{A}^{\\textbf{y}}$  &${\\sigma}_{\\pi_{h}}^{\\textbf{y}}$&  ${\\sigma}_{\\pi_x}^{\\textbf{y}}$&  ${\\sigma}_{\\pi_f}^{\\textbf{y}}$ &  ${\\sigma}_{\\pi_g}^{\\textbf{y}}$&  ${\\sigma}_{\\pi_n}^{\\textbf{y}}$\\\\'); 
   fprintf(fid2,'\n \\hline');
   fprintf(fid2,'\n  \\multicolumn{7}{c}{\\textbf{Entire Sample} }		    \\\\');
   fprintf(fid2,'\n \\hline');
ex=['sgy=(1./var(ycm_t(:,1:6)))./sum(1./var(ycm_t(:,1:6)));'];
eval(ex)
ex=['sgh=(1./var(hcm_t(:,1:6)))./sum(1./var(hcm_t(:,1:6)));'];
eval(ex)
ex=['sgx=(1./var(xcm_t(:,1:6)))./sum(1./var(xcm_t(:,1:6)));'];   
eval(ex)
ex=['sgl=(1./var(ccm_t(:,1:6)))./sum(1./var(ccm_t(:,1:6)));'];   
eval(ex)
sg=[sgh;sgy;sgx;sgl];
   fprintf(fid2,'\n  $l$    & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f		\\\\',[sg(1,1:3) sg(1,6) sg(1,4:5)]');
   fprintf(fid2,'\n  $y$    & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f	    \\\\',[sg(2,1:3) sg(2,6) sg(2,4:5)]');
   ...
   fprintf(fid2,'\n  $s_l$  & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f		\\\\',[sg(4,1:3) sg(4,6) sg(4,4:5)]');
   fprintf(fid2,'\n \\hline');
   fprintf(fid2,'\n  \\multicolumn{7}{c}{\\textbf{The Economic Miracle} }		    \\\\');
   fprintf(fid2,'\n \\hline');
ex=['sgy=(1./var(ycm_t(find(timeline>=1967 & timeline<=1973),1:6)))./sum(1./var(ycm_t(find(timeline>=1967 & timeline<=1973),1:6)));'];
eval(ex)
ex=['sgh=(1./var(hcm_t(find(timeline>=1967 & timeline<=1973),1:6)))./sum(1./var(hcm_t(find(timeline>=1967 & timeline<=1973),1:6)));'];
eval(ex)
ex=['sgx=(1./var(xcm_t(find(timeline>=1967 & timeline<=1973),1:6)))./sum(1./var(xcm_t(find(timeline>=1967 & timeline<=1973),1:6)));'];   
eval(ex)
ex=['sgl=(1./var(ccm_t(find(timeline>=1967 & timeline<=1973),1:6)))./sum(1./var(ccm_t(find(timeline>=1967 & timeline<=1973),1:6)));'];   
eval(ex)
sg=[sgh;sgy;sgx;sgl];
   fprintf(fid2,'\n  $l$    & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f		\\\\',[sg(1,1:3) sg(1,6) sg(1,4:5)]');
   fprintf(fid2,'\n  $y$    & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f	    \\\\',[sg(2,1:3) sg(2,6) sg(2,4:5)]');
   ...
   fprintf(fid2,'\n  $s_l$  & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f		\\\\',[sg(4,1:3) sg(4,6) sg(4,4:5)]');
   fprintf(fid2,'\n \\hline');
   fprintf(fid2,'\n  \\multicolumn{7}{c}{\\textbf{The Oil Recessions} }		    \\\\');
   fprintf(fid2,'\n \\hline');
ex=['sgy=(1./var(ycm_t(find(timeline>=1973 & timeline<=1982),1:6)))./sum(1./var(ycm_t(find(timeline>=1973 & timeline<=1982),1:6)));'];
eval(ex)
ex=['sgh=(1./var(hcm_t(find(timeline>=1973 & timeline<=1982),1:6)))./sum(1./var(hcm_t(find(timeline>=1973 & timeline<=1982),1:6)));'];
eval(ex)
ex=['sgx=(1./var(xcm_t(find(timeline>=1973 & timeline<=1982),1:6)))./sum(1./var(xcm_t(find(timeline>=1973 & timeline<=1982),1:6)));'];   
eval(ex)
ex=['sgl=(1./var(ccm_t(find(timeline>=1973 & timeline<=1982),1:6)))./sum(1./var(ccm_t(find(timeline>=1973 & timeline<=1982),1:6)));'];   
eval(ex)
sg=[sgh;sgy;sgx;sgl];
   fprintf(fid2,'\n  $l$    & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f		\\\\',[sg(1,1:3) sg(1,6) sg(1,4:5)]');
   fprintf(fid2,'\n  $y$    & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f	    \\\\',[sg(2,1:3) sg(2,6) sg(2,4:5)]');
   ...
   fprintf(fid2,'\n  $s_l$  & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f		\\\\',[sg(4,1:3) sg(4,6) sg(4,4:5)]');
   fprintf(fid2,'\n \\hline');
   fprintf(fid2,'\n  \\multicolumn{7}{c}{\\textbf{The Industrial Reestructuring} }		    \\\\');
   fprintf(fid2,'\n \\hline');
ex=['sgy=(1./var(ycm_t(find(timeline>=1982 & timeline<=1986),1:6)))./sum(1./var(ycm_t(find(timeline>=1982 & timeline<=1986),1:6)));'];
eval(ex)
ex=['sgh=(1./var(hcm_t(find(timeline>=1982 & timeline<=1986),1:6)))./sum(1./var(hcm_t(find(timeline>=1982 & timeline<=1986),1:6)));'];
eval(ex)
ex=['sgx=(1./var(xcm_t(find(timeline>=1982 & timeline<=1986),1:6)))./sum(1./var(xcm_t(find(timeline>=1982 & timeline<=1986),1:6)));'];   
eval(ex)
ex=['sgl=(1./var(ccm_t(find(timeline>=1982 & timeline<=1986),1:6)))./sum(1./var(ccm_t(find(timeline>=1982 & timeline<=1986),1:6)));'];   
eval(ex)
sg=[sgh;sgy;sgx;sgl];
   fprintf(fid2,'\n  $l$    & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f		\\\\',[sg(1,1:3) sg(1,6) sg(1,4:5)]');
   fprintf(fid2,'\n  $y$    & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f	    \\\\',[sg(2,1:3) sg(2,6) sg(2,4:5)]');
   ...
   fprintf(fid2,'\n  $s_l$  & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f		\\\\',[sg(4,1:3) sg(4,6) sg(4,4:5)]');
   fprintf(fid2,'\n \\hline');
   fprintf(fid2,'\n  \\multicolumn{7}{c}{\\textbf{The European Integration} }		    \\\\');
   fprintf(fid2,'\n \\hline');
ex=['sgy=(1./var(ycm_t(find(timeline>=1986 & timeline<=1991),1:6)))./sum(1./var(ycm_t(find(timeline>=1986 & timeline<=1991),1:6)));'];
eval(ex)
ex=['sgh=(1./var(hcm_t(find(timeline>=1986 & timeline<=1991),1:6)))./sum(1./var(hcm_t(find(timeline>=1986 & timeline<=1991),1:6)));'];
eval(ex)
ex=['sgx=(1./var(xcm_t(find(timeline>=1986 & timeline<=1991),1:6)))./sum(1./var(xcm_t(find(timeline>=1986 & timeline<=1991),1:6)));'];   
eval(ex)
ex=['sgl=(1./var(ccm_t(find(timeline>=1986 & timeline<=1991),1:6)))./sum(1./var(ccm_t(find(timeline>=1986 & timeline<=1991),1:6)));'];   
eval(ex)
sg=[sgh;sgy;sgx;sgl];
   fprintf(fid2,'\n  $l$    & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f		\\\\',[sg(1,1:3) sg(1,6) sg(1,4:5)]');
   fprintf(fid2,'\n  $y$    & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f	    \\\\',[sg(2,1:3) sg(2,6) sg(2,4:5)]');
   ...
   fprintf(fid2,'\n  $s_l$  & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f		\\\\',[sg(4,1:3) sg(4,6) sg(4,4:5)]');
   fprintf(fid2,'\n \\hline');
   fprintf(fid2,'\n  \\multicolumn{7}{c}{\\textbf{The European Crisis} }		    \\\\');
   fprintf(fid2,'\n \\hline');
ex=['sgy=(1./var(ycm_t(find(timeline>=1991 & timeline<=1994),1:6)))./sum(1./var(ycm_t(find(timeline>=1991 & timeline<=1994),1:6)));'];
eval(ex)
ex=['sgh=(1./var(hcm_t(find(timeline>=1991 & timeline<=1994),1:6)))./sum(1./var(hcm_t(find(timeline>=1991 & timeline<=1994),1:6)));'];
eval(ex)
ex=['sgx=(1./var(xcm_t(find(timeline>=1991 & timeline<=1994),1:6)))./sum(1./var(xcm_t(find(timeline>=1991 & timeline<=1994),1:6)));'];   
eval(ex)
ex=['sgl=(1./var(ccm_t(find(timeline>=1991 & timeline<=1994),1:6)))./sum(1./var(ccm_t(find(timeline>=1991 & timeline<=1994),1:6)));'];   
eval(ex)
sg=[sgh;sgy;sgx;sgl];
   fprintf(fid2,'\n  $l$    & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f		\\\\',[sg(1,1:3) sg(1,6) sg(1,4:5)]');
   fprintf(fid2,'\n  $y$    & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f	    \\\\',[sg(2,1:3) sg(2,6) sg(2,4:5)]');
   ...
   fprintf(fid2,'\n  $s_l$  & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f		\\\\',[sg(4,1:3) sg(4,6) sg(4,4:5)]');
   fprintf(fid2,'\n \\hline');
   fprintf(fid2,'\n  \\multicolumn{7}{c}{\\textbf{The Pre‑Great Recession Expansion} }		    \\\\');
   fprintf(fid2,'\n \\hline');
ex=['sgy=(1./var(ycm_t(find(timeline>=1994 & timeline<=2007),1:6)))./sum(1./var(ycm_t(find(timeline>=1994 & timeline<=2007),1:6)));'];
eval(ex)
ex=['sgh=(1./var(hcm_t(find(timeline>=1994 & timeline<=2007),1:6)))./sum(1./var(hcm_t(find(timeline>=1994 & timeline<=2007),1:6)));'];
eval(ex)
ex=['sgx=(1./var(xcm_t(find(timeline>=1994 & timeline<=2007),1:6)))./sum(1./var(xcm_t(find(timeline>=1994 & timeline<=2007),1:6)));'];   
eval(ex)
ex=['sgl=(1./var(ccm_t(find(timeline>=1994 & timeline<=2007),1:6)))./sum(1./var(ccm_t(find(timeline>=1994 & timeline<=2007),1:6)));'];   
eval(ex)
sg=[sgh;sgy;sgx;sgl];
   fprintf(fid2,'\n  $l$    & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f		\\\\',[sg(1,1:3) sg(1,6) sg(1,4:5)]');
   fprintf(fid2,'\n  $y$    & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f	    \\\\',[sg(2,1:3) sg(2,6) sg(2,4:5)]');
   ...
   fprintf(fid2,'\n  $s_l$  & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f		\\\\',[sg(4,1:3) sg(4,6) sg(4,4:5)]');
   fprintf(fid2,'\n \\hline');
   fprintf(fid2,'\n  \\multicolumn{7}{c}{\\textbf{The Great Recession} }		    \\\\');
   fprintf(fid2,'\n \\hline');
ex=['sgy=(1./var(ycm_t(find(timeline>=2007 & timeline<=2014),1:6)))./sum(1./var(ycm_t(find(timeline>=2007 & timeline<=2014),1:6)));'];
eval(ex)
ex=['sgh=(1./var(hcm_t(find(timeline>=2007 & timeline<=2014),1:6)))./sum(1./var(hcm_t(find(timeline>=2007 & timeline<=2014),1:6)));'];
eval(ex)
ex=['sgx=(1./var(xcm_t(find(timeline>=2007 & timeline<=2014),1:6)))./sum(1./var(xcm_t(find(timeline>=2007 & timeline<=2014),1:6)));'];   
eval(ex)
ex=['sgl=(1./var(ccm_t(find(timeline>=2007 & timeline<=2014),1:6)))./sum(1./var(ccm_t(find(timeline>=2007 & timeline<=2014),1:6)));'];   
eval(ex)
sg=[sgh;sgy;sgx;sgl];
   fprintf(fid2,'\n  $l$    & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f		\\\\',[sg(1,1:3) sg(1,6) sg(1,4:5)]');
   fprintf(fid2,'\n  $y$    & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f	    \\\\',[sg(2,1:3) sg(2,6) sg(2,4:5)]');
   ...
   fprintf(fid2,'\n  $s_l$  & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f		\\\\',[sg(4,1:3) sg(4,6) sg(4,4:5)]');   
   fprintf(fid2,'\n \\hline');
   fprintf(fid2,'\n  \\multicolumn{7}{c}{\\textbf{Post‑Great Recession expansion} }		    \\\\');
   fprintf(fid2,'\n \\hline');
ex=['sgy=(1./var(ycm_t(find(timeline>=2014 & timeline<=2019),1:6)))./sum(1./var(ycm_t(find(timeline>=2014 & timeline<=2019),1:6)));'];
eval(ex)
ex=['sgh=(1./var(hcm_t(find(timeline>=2014 & timeline<=2019),1:6)))./sum(1./var(hcm_t(find(timeline>=2014 & timeline<=2019),1:6)));'];
eval(ex)
ex=['sgx=(1./var(xcm_t(find(timeline>=2014 & timeline<=2019),1:6)))./sum(1./var(xcm_t(find(timeline>=2014 & timeline<=2019),1:6)));'];   
eval(ex)
ex=['sgl=(1./var(ccm_t(find(timeline>=2014 & timeline<=2019),1:6)))./sum(1./var(ccm_t(find(timeline>=2014 & timeline<=2019),1:6)));'];   
eval(ex)
sg=[sgh;sgy;sgx;sgl];
   fprintf(fid2,'\n  $l$    & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f		\\\\',[sg(1,1:3) sg(1,6) sg(1,4:5)]');
   fprintf(fid2,'\n  $y$    & %8.3f     & %8.3f	& %8.3f	& %8.3f     & %8.3f	& %8.3f	    \\\\',[sg(2,1:3) sg(2,6) sg(2,4:5)]');
   ...
   fprintf(fid2,'\n \\fnote{Note: $\\sigma_i^{\\mathbf{y}}=1/Var\\left( \\log \\mathbf{z}^{\\mathbf{y}}_{i,t}\\right) /\\sum_{j}\\left(1/Var\\left( \\log \\mathbf{z}^{\\mathbf{y}}_{j,t}\\right) \\right) $ where $\\mathbf{z}^{\\mathbf{y}}_{j,t} \\in \\{z^l_{j,t}, z^y_{j,t}, z^x_{j,t}, z^{s_l}_{j,t}\\}$ denotes the non-wedge component of variable $\\mathbf{y}_t$ associated with wedge $j$.}');
   fprintf(fid2,'\n \\end{table}');
   fclose(fid2);
