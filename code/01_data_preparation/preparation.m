...
%%% Table summarises the values of the calibrated parameters as well as the 
%%% values of the endogenous and exogenous variables in the BGP.

   fid2=fopen("tables/tableparam.tex","w");
   fprintf(fid2,'\\begin{table}[h]');
   fprintf(fid2,'\n \\begin{center}');
   fprintf(fid2,'\n \\begin{tabular}{l|l|c}');
   fprintf(fid2,'\n \\hline\\hline');
   fprintf(fid2,'\n  \\multicolumn{3}{c}{\\textsc{Household}}		\\\\');
   fprintf(fid2,'\n \\hline');   
   fprintf(fid2,'\n  $\\beta$         & Discount Rate                          & %8.6f		    \\\\', beta);
   fprintf(fid2,'\n  $\\nu $          & Frisch Elasticity  -1/($\\nu$)         & %8.6f		    \\\\', nu);   
   fprintf(fid2,'\n \\hline');   
   fprintf(fid2,'\n  \\multicolumn{3}{c}{\\textsc{Firm} }		    \\\\');
   fprintf(fid2,'\n \\hline');
   fprintf(fid2,'\n  $\\rho $         & Inputs Elasticity of Substitution 1/(1-$\\rho$)& %8.6f	 \\\\', rho);   
   fprintf(fid2,'\n  $\\alpha$        & Share Parameter of Production Function & %8.6f		    \\\\', alfa);   
   fprintf(fid2,'\n  $\\delta   $     & Depreciation Rate of Capital           & %8.6f		    \\\\', delta);   
   fprintf(fid2,'\n  $\\phi     $     & Adjustment Cost Paramenter             & %8.6f		    \\\\', phi);   
   fprintf(fid2,'\n  $\\Phi     $     & Adjustment Cost Paramenter             & %8.6f		    \\\\', Phi);   
   fprintf(fid2,'\n  $\\gamma   $     & Labour Efficiency Growth Rate          & %8.6f		    \\\\', gamy);   
   fprintf(fid2,'\n   \\hline');
   fprintf(fid2,'\n  \\multicolumn{3}{c}{\\textsc{bgp} Wedges }		    \\\\');
   fprintf(fid2,'\n   \\hline');
   fprintf(fid2,'\n  $A     $     & Efficiency              & %8.6f		    \\\\', A_bar);   
   fprintf(fid2,'\n  $\\pi_h$     & Household Labour        & %8.6f		    \\\\', pi_h_bar);  
   fprintf(fid2,'\n  $\\pi_f$     & Firm Labour             & %8.6f		    \\\\', pi_f_bar);   
   fprintf(fid2,'\n  $\\pi_x$     & Investment              & %8.6f		    \\\\', pi_x_bar); 
   fprintf(fid2,'\n  $\\pi_g$     & Government              & %8.6f		    \\\\', pi_g_bar);   
   fprintf(fid2,'\n  $\\pi_n$     & Population Growth Rate       & %8.6f		    \\\\', pi_n_bar);   
   fprintf(fid2,'\n   \\hline');
   fprintf(fid2,'\n  \\multicolumn{3}{c}{\\textsc{bgp} Variables }		    \\\\');
   fprintf(fid2,'\n   \\hline');
   fprintf(fid2,'\n  $k/y     $     & Capital-Output Ratio       & %8.6f		    \\\\', ke/ye);   
   fprintf(fid2,'\n  $l       $     & Labour per Capita          & %8.6f		    \\\\', le);  
   fprintf(fid2,'\n  $x/y     $     & Investment Rate            & %8.6f		    \\\\', xe/ye);   
   fprintf(fid2,'\n  $s_l     $     & Labour Share               & %8.6f		    \\\\', sle);   
   fprintf(fid2,'\n \\hline\\hline');
   fprintf(fid2,'\n \\end{tabular}');
   fprintf(fid2,'\n \\end{center}');
   fprintf(fid2,'\n \\caption{Parameters and \\textsc{bgp} Variables.}');
   fprintf(fid2,'\n \\label{TableCal}');
   fprintf(fid2,'\n \\end{table}');
   fclose(fid2);
